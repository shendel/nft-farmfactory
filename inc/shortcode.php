 ...
 */
function nftfarmfactory_shortcode_inline_scripts( $id ) {
	$inline_scripts  = "\n";
 ...
 * Main Shortcode
 */
function nftfarmfactory_main_shortcode( $atts ) {
	...
	$id             = $atts['id'];
	$html           = '';
	$farms          = wp_count_posts( 'nftfarmfactory' )->publish;
	$inline_scripts = '';
...
add_shortcode( 'nftfarmfactory', 'nftfarmfactory_main_shortcode' );
 ...
 * Price Shortcode
 */
function nftfarmfactory_price_shortcode( $attrs ) {
...
add_shortcode( 'nftfarmfactoryPrice', 'nftfarmfactory_price_shortcode' );